...
description: DEPRECATED — use /cortex-documenter skill instead. Persist sessions via the legacy Reconstruction flow.
tools: Read, Write, mcp__cortex__cortex_save_session, mcp__cortex__cortex_finish_session, mcp__cortex__cortex_session_status, mcp__cortex__cortex_verify_session_claims, mcp__cortex__cortex_validate_handoff, mcp__cortex__cortex_search, mcp__cortex__cortex_ping
---
