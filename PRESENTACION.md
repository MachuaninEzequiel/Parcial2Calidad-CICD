...
**Qué mostrar:** la caja de texto libre ya habilitada; tipear *"juego para jugar con amigos en el sillón"* y que aparezca el top-5 (con Overcooked 2 en la lista); abrir `site/js/vectorizer.mjs` y el import map de `index.html`; y `node --test tests/equivalence/embed.equiv.test.mjs` en verde.
