...
1. Run tests locally: `echo 'no test command detected'`
2. Check for environment differences
3. Search Cortex for similar failures: `cortex search "test failure"`

### Lint Errors

1. Run lint locally: `echo 'no lint command detected'`
2. Auto-fix if possible: `echo 'no lint command detected' --fix` (if supported)
